<?php if (!defined('THINK_PATH')) exit();?><html>
    ...
    <body>
        ...
        <div class="center" style="height:20px;padding-top: 10px;">当前位置：<a href='__APP__'>首页</a>>><a href='__APP__/Album/lists/'>相册列表</a> >><?php echo ($uname); ?>的相册</div>
             ...
             <table>
                ...
                <?php if(is_array($arr)): foreach($arr as $key=>$val): ?><td width="240" height="260">
                        <table>
                            ...
                            <tr><td>图片个数：<?php echo ($val["p_count"]); ?></td></tr>
                        </table>
                    </td>
