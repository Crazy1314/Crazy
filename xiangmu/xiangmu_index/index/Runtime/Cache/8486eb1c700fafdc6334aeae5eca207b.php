	      ...
	      <aside id="categories_nav">
		     ...
		     <nav class="left_menu">
			    <ul>
				   ...
				   <li class="last"><a href="#">Food</a></li>
			    </ul>
		     </nav><!-- .left_menu -->
       ...
       <div id="content" class="grid_9">
		<article class="post view_post">
			...
			<div class="footer_article">
				...
				<span>Mike Example, <time datetime="2012-11-03">03.11.2012</time></span>  |  <span>Posted in <a href="#">Sports</a>, <a href="#">Movies</a></span>
			</div>
		</article>
		<div class="comments_blog">
			...
			<ul class="comments">
				<li>
					<div class="avatar"><img src="__PUBLIC__/images/avatar.png" alt="Avatar"/></div>
					<div class="autor">Mike Example</div>, <time datetime="2012-11-03">03.11.2012</time>
					<p>Suspendisse at placerat turpis. Duis luctus erat vel magna pharetra aliquet. Maecenas tincidunt feugiat ultricies. Phasellus et dui risus. Vestibulum adipiscing, eros quis lobortis dictum.  Many desktop publishing packages and web page editors now use.</p>
				</li>
