...
<body>
  ...
  <div class="container_12">
    <div class="grid_12">
        ...
        <div id="slider">
          <div id="slide1">
            <img src="__PUBLIC__/images/content/slide1.jpg" alt="" title="" />
            <div class="slid_text">
          ...
          <div id="slide2">
            <img src="__PUBLIC__/images/content/slide2.jpg" alt="" title="" />
            <div class="slid_text">
          ...
          <div id="slide3">
            <img src="__PUBLIC__/images/content/slide3.jpg" alt="" title="" />
            <div class="slid_text">
      ...
      <div id="top_button">
        <div class="grid_4">
          <a href="#" class="button_block best_price">
            <img src="__PUBLIC__/images/banner1.png" alt="Banner 1"/>
          </a><!-- .best_price -->
        </div><!-- .grid_4 -->

        <div class="grid_4">
          <a href="#" class="button_block new_smells">
            <img src="__PUBLIC__/images/banner2.png" alt="Banner 2"/>
          </a><!-- .new smells -->
        </div><!-- .grid_4 -->

        <div class="grid_4">
          <a href="#" class="button_block only_natural">
            <img src="__PUBLIC__/images/banner3.png" alt="Banner 3"/>
          </a><!-- .only_natural -->
        </div><!-- .grid_4 -->
