...
<head>
  ...
  <link rel="stylesheet" href="__PUBLIC__/css/jquery.jqzoom.css" type="text/css">
		...
		<div class="product_page">
			<div class="grid_4 img_slid" id="products">
				...
				<div class="preview slides_container">
					<div class="prev_bg">
						<a href="__PUBLIC__/images/produkt_slid.png" class="jqzoom" rel='gal1' title="">
							<img src="__PUBLIC__/images/produkt_slid.png"  title="" alt=""/>
						</a>
					</div>
				</div><!-- .prev -->

				<ul class="pagination clearfix" id="thumblist">
					<li><a class="zoomThumbActive" href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: './__PUBLIC__/images/produkt_slid.png',largeimage: './__PUBLIC__/images/produkt_slid.png'}"><img src='__PUBLIC__/images/produkt_slid.png' alt=""></a></li>
					<li><a href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: './__PUBLIC__/images/produkt_slid1.png',largeimage: './__PUBLIC__/images/produkt_slid1.png'}"><img src='__PUBLIC__/images/produkt_slid1.png' alt=""></a></li>
					<li><a href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: './__PUBLIC__/images/produkt_slid2.png',largeimage: './__PUBLIC__/images/produkt_slid2.png'}"><img src='__PUBLIC__/images/produkt_slid2.png' alt=""></a></li>
					<li><a href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: './__PUBLIC__/images/produkt_slid3.png',largeimage: './__PUBLIC__/images/produkt_slid3.png'}"><img src='__PUBLIC__/images/produkt_slid3.png' alt=""></a></li>
					<li><a href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: './__PUBLIC__/images/produkt_slid4.png',largeimage: './__PUBLIC__/images/produkt_slid4.png'}"><img src='__PUBLIC__/images/produkt_slid4.png' alt=""></a></li>
				</ul>
			...
			<div class="grid_5">
				<div class="entry_content">
					...
					<div class="soc">
						<img src="__PUBLIC__/images/soc.png" alt="Soc"/>
					</div><!-- .soc -->
				</div><!-- .entry_content -->
				...
				<div id="wrapper_tab" class="tab1">
                    ...
                    <div class="tab2 tab_body">
                        ...
                        <ul class="comments">
                            ...
                            <li>
                                <div class="autor">Mike Example</div>, <time datetime="<?php echo $v['time']; ?>"><?php echo $v['time']; ?></time>

                                <div class="evaluation">
                                    <div class="quality">
                                        <strong>质量</strong>
                                        <?php for($i=0;$i<$v['quality'];$i++){ ?>
                                        <a class="plus" href="#"></a>
                                        <?php }?>
                                        <?php for($i=0;$i<5-$v['quality'];$i++){ ?>
                                        <a  href="#"></a>
                                        <?php }?>
                                    </div>
                                    <div class="price">
                                        <strong>价格</strong>
                                        <?php for($i=0;$i<$v['price'];$i++){ ?>
                                        <a class="plus" href="#"></a>
                                        <?php }?>
                                        <?php for($i=0;$i<5-$v['price'];$i++){ ?>
                                        <a  href="#"></a>
                                        <?php }?>
                                    </div>
                                    <div class="clear"></div>
                        ...
                        <form class="add_comments" action="__APP__/Review/addreview" method="post">
                            <h4>Write Your Own Review</h4>
                            <input type="hidden" value="1" name="goods_id">
                            ...
                            <div class="text_review">
                                <strong>评价</strong><sup class="surely">*</sup><br/>
