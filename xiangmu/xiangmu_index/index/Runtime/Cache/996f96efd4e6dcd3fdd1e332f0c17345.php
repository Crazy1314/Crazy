  ...
  <section id="main" class="entire_width">
    <div class="container_12">
       ...
       <table class="cart_product">
	      ...
	      <tr>
		     <td class="images"><a href="product_page.html"><img src="__PUBLIC__/images/product_6.png" alt="Product 6"></a></td>
		     <td class="bg name">Paddywax香味扩散器设置，栀子夜来香， <br/> 茉莉花，4盎司 </td>
	      ...
	      <tr>
		     <td class="images"><a href="product_page.html"><img src="__PUBLIC__/images/produkt_slid1.png" alt="Product Slide 1"></a></td>
		     <td class="bg name">加州香水Spillproof有机空气清新剂，<br/>科罗纳樱桃，1.5盎司储罐 </td>
		     <td class="edit"><a title="Edit" href="#">Edit</a></td>
		     <td class="bg price">$75.00</td>
		     <td class="qty"><input type="text" name="" value="" placeholder="1000" /></td>
		     <td class="bg subtotal">$750.00</td>
