...
<head>
  ...
  <link rel="shortcut icon" href="__PUBLIC__/images/favicon.html">
  ...
  <div id="block_nav_primary">
    <div class="container_12">
      <div class="grid_12">
		...
		<li><a href="__APP__/Index/404">404</a></li>
  ...
  <div class="container_12">
    <div class="grid_12">
       <div class="breadcrumbs">
	      <a href="__APP__/Index/index">Home</a><span>&#8250;</span><a href="#">Category</a><span>&#8250;</span><span class="current">This page</span>
       </div><!-- .breadcrumbs -->
    </div><!-- .grid_12 -->
  </div><!-- .container_12 -->
  ...
  <section id="main">
    <div class="container_12">
       <div id="sidebar" class="grid_3">
	      ...
	      <aside id="specials" class="specials">
		     ...
		     <ul>
			    <li>
				   <div class="prev">
					  <a href="__APP__/Index/product_page"><img src="__PUBLIC__/images/special1.png" alt="" title="" /></a>
				   </div>
				   
				   <div class="cont">
					  <a href="__APP__/Index/product_page">Honeysuckle Flameless Luminary Refill</a>
			    ...
			    <li>
				   <div class="prev">
					  <a href="__APP__/Index/product_page"><img src="__PUBLIC__/images/special2.png" alt="" title="" /></a>
				   </div>
       ...
       <div id="content" class="grid_9">
	      ...
	      <div class="options">
		     <div class="grid-list">
			   <a class="grid" href="__APP__/Index/catalog_grid"><span>img</span></a>
			   <a class="list curent" href="__APP__/Index/index"><span>img</span></a>
		     </div><!-- .grid-list -->
	      ...
	      <div class="listing_product">
			<div class="product_li">
				<div class="grid_3">
					<img class="sale" src="__PUBLIC__/images/new.png" alt="New"/>
					<div class="prev">
				...
				<div class="grid_4">
					<div class="entry_content">
						<a href="__APP__/Index/product_page"><h3 class="title">Beanpod Candles Orange Vanilla, Tea Light</h3></a>
						<div class="review">
							<a class="plus" href="#"></a>
							<a class="plus" href="#"></a>
							<a class="plus" href="#"></a>
						...
						<a class="more" href="__APP__/Index/product_page">Learn More</a>
					</div><!-- .entry_content -->
				</div><!-- .grid_4 -->
			...
			<div class="product_li">
				<div class="grid_3">
					<img class="sale" src="__PUBLIC__/images/top.png" alt="Top"/>
					<div class="prev">
