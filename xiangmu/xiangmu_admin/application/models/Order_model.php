...
class Order_model extends CI_Model {
    ...
    public function sel_co($u_name,$border_num,$total){
        if($border_num==''&&$u_name==''&&$total==''){
            ...
            $where="and user.user_name like '%$u_name%' ";
        }else if($border_num==''&&$u_name==''){
            $where="and border.border_state='$total'";
        }else if($u_name==''){
            $where="and border.border_number like '%$u_name%' and border.border_state='$total' ";
        }else if($border_num==''){
            $where="and user.user_name like '%$u_name%' and border.border_state='$total' ";
        }else if($total==''){
            $where="and user.user_name like '%$u_name%' and border.border_number like '%$border_num%'";
        }else  if($border_num!=''&&$u_name!=''&&$total!=''){
            $where="and border.border_state='$total' and user.user_name like '%$u_name%' and border.border_number like '%$border_num%'";
        }
