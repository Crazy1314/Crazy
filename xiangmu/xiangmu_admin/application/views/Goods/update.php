    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo site_url('Goods/up_data');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <?php foreach($goods as $k=>$v):?>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input value="<?php echo $v['goods_name']?>" class="common-text required" name="goods_name" size="50" type="text">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select name="brand_id" class="required">
                                        ...
                                        <?php foreach($brand as $k=>$vv):?>
                                            <option value="<?php echo $vv['brand_id']?>">
                                                <?php echo $vv['brand_name']?></option>
                                        <?php endforeach?>
                                    </select>
                                </td> 
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select name="goods_type_id" class="required">
                                        <option value="0">请选择</option>
                                        <?php foreach($type as $k=>$vvv):?>
                                            <option value="<?php echo $vvv['goods_type_id']?>">
                                                <?php echo $vvv['goods_type_name']?></option>
                                        <?php endforeach?>
                                    </select>
                                </td> 
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                <?php if($v['stores']==1){?>
                                    <input type="radio" name="stores" value="1" checked>上架
                                    <input type="radio" name="stores" value="0">下架
                                <?php }else{?>
                                    <input type="radio" name="stores" value="1">上架
                                    <input type="radio" name="stores" value="0" checked>下架
                                <?php }?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <?php if($v['hot']==1){?>
                                        <input type="radio" name="hot" value="1" checked>热卖
                                        <input type="radio" name="hot" value="0">非热卖
                                    <?php }else{?>
                                        <input type="radio" name="hot" value="1">热卖
                                        <input type="radio" name="hot" value="0" checked>非热卖
                                    <?php }?>
                                </td>
                            </tr>
                             <tr>
                                ...
                                <td>
                                    <?php if($v['new']==1){?>
                                        <input type="radio" name="new" value="1" checked>新品
                                        <input type="radio" name="new" value="0">非新品
                                    <?php }else{?>
                                        <input type="radio" name="new" value="1">新品
                                        <input type="radio" name="new" value="0" checked>非新品
                                    <?php }?>
                                </td>
                            </tr>
                            <tr>
